...
Write-Host "🔍 Current active pods in 'spotify' namespace:" -ForegroundColor Cyan
kubectl -n spotify get pods
Write-Host ""

# DEMO 1: POD DELETION & AUTO-RECOVERY
Write-Host "🧪 DEMO 1: Simulating Pod Crash (Sudden termination of container)..." -ForegroundColor Yellow
...
for ($i = 0; $i -lt 15; $i++) {
    ...
    Write-Host "==========================================================" -ForegroundColor Magenta
    Write-Host ""
    Write-Host "💥 Killed: $targetPod" -ForegroundColor Red
...
Write-Host ""
Write-Host "🧪 DEMO 2: Checking Auto-Scaling Configuration (HPA)..." -ForegroundColor Yellow
...
Write-Host ""
Write-Host "🎉 Self-healing works seamlessly! The replicator controller guarantees high availability." -ForegroundColor Green
